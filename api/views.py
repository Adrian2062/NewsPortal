...
class CommentListcreateAPIView(APIView):
    """
    GET  -> Public (Anyone can view comments)
    POST -> Only authenticated users can create comments
    """
...
class CommentDetailAPIView(APIView):
    """
    GET, PUT, PATCH, DELETE for a single comment.
    Only Staff or Comment Owner can edit/delete.
    """
